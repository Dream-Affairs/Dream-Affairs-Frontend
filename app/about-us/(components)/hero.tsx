  ...
  return (
    <section className="w-full h-[321px] md:h-[400px] lg:h-[434px] flex flex-col justify-center items-center px-[24px] lg:px-0">
      ...
      <div className="text-[#ECF1F8] lg:mt-0 flex flex-col items-center px-[13px] lg:px-0">
        <h4 className="font-[500] text-[12px] sm:text-[18px] lg:text-[24px] leading-[16.8px] sm:leading-[18.6px] lg:leading-[33.6px]">
          Welcome to DreamAffairs
        </h4>
        <h2 className="mt-[20px] lg:mt-0 font-[700] lg:font-[600] text-center text-[24px] sm:text-[32px] lg:text-[64px] lg:leading-[89.6px] leading-[33.6px]">
