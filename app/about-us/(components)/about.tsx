    ...
    <section className="relative w-full px-[24px] lg:h-[919px] flex flex-col sm:flex-row lg:mt-[50px] lg:pl-[81px] sm:pt-[32px] lg:pt-[125px] sm:gap-x-[50px] lg:gap-x-[135px]">
      ...
      <div className="lg:w-[617px] sm:w-full flex flex-col gap-y-[16px]">
        <div data-aos="fade-up" className="lg:w-[617px] flex flex-col gap-y-[16px] lg:gap-y-[11px]">
          ...
          />
          <h3 className="font-[600] text-[16px] sm:text-[18px] lg:text-[48px] leading-[22.4px] sm:leading-[24.6px] lg:leading-[67.2px] text-[#48195A]">
            Our Mission
          </h3>
        ...
        <div
          data-aos="fade-up"
          className="lg:w-[617px] mt-[24px] lg:mt-[88px] flex flex-col gap-y-[16px] lg:gap-y-[11px]"
        >
          <Image
            src={entrance}
            alt="ailse entrance "
      ...
      <div data-aos="fade-up" className="sm:w-full hidden sm:block lg:mt-[78px] smpl-[20px] lg:pl-0">
        <Image
          ...
          width={291}
          height={372}
          className=" sm:-ml[40px] lg:-ml-0 sm:pr-[40px] lg:pr-0 sm:w-[362px] sm:h-[254px] lg:w-[291px] lg:h-[372px] object-cover"
        />
        <Image
          src={entrance}
          alt="ailse entrance "
          width={291}
          height={372}
          className="lg:ml-[185px] sm:w-[362px] sm:h-[254px] lg:w-[291px] sm:pl-[40px] lg:h-[372px] sm:-mt-[40px] lg:-mt-[113px] object-cover"
        />
      </div>
    </section>
  );
