...
const Contact = () => {
  return (
    <div className="bg-[#090909] bg-opacity-[60%] bg-blend-overlay bg-cover bg-center lg:h-[522px] h-[402px] flex items-center justify-center mb-[40px] lg:mb-[83px]" style={{ backgroundImage:  `url(${contactBg.src})`}}>
