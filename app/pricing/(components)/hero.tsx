...
const Hero = () => {
  return (
    <section>
      <div
        className="lg:bg-black lg:bg-opacity-[50%] lg:bg-blend-overlay lg:bg-cover lg:bg-center lg:h-[493px] lg:flex justify-center hidden"
      ...
      <div
        className="bg-black bg-opacity-[50%] bg-blend-overlay bg-cover bg-center h-[493px] flex justify-center lg:hidden"
