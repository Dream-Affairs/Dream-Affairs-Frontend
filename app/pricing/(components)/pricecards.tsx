  ...
  return (
    <section className='w-[80%] mx-auto flex lg:flex-row flex-col items-center justify-between lg:mt-[-100px] my-[40px] lg:mb-[118px]'>
        <div className='lg:w-[325px] w-[327px] lg:h-[700px] h-[644px] rounded-[20px] lg:px-4 px-[19px] border-[#EBEBEB] border text-[14px] bg-white mb-[20px] lg:mb-0'>
            ...
            <Button size='lg' variant='outline' className='w-[100%] lg:mt-[55px] mt-[40px] h-[56px] text-[16px]'>Choose Plan</Button>
        </div>
        ...
        <p className='text-[#008D36] lg:text-[16px] text-[10px] font-[500] bg-[#E6F4EB] lg:w-[134px] w-[86px] lg:h-[30px] h-[22px] rounded-[8px] self-end flex justify-center items-center absolute lg:top-[27px] top-[8px] lg:right-[24px] right-[8px]'>Recommended</p>
        <div className='lg:px-4 px-[19px]'>
            ...
            <Button size='lg' variant='secondary' className='w-[100%] lg:mt-[22px] mt-[40px] mb-[28px] h-[56px] text-[16px]'>Choose Plan</Button>
            </div>
        </div>
        </div>
        <div className='lg:w-[325px] w-[327px] lg:h-[700px] h-[683px] rounded-[20px] lg:px-4 px-[19px] border-[#EBEBEB] border text-[14px] bg-white mb-[20px] lg:mb-0'>
            ...
            <Button size='lg' variant='outline' className='w-[100%] lg:mt-[32px] mt-[40px] mb-[28px] h-[56px] text-[16px]'>Choose Plan</Button>
        </div>
    </section>
  )
}
