  ...
  return (
    ...
    >
      <div className="text-center text-white w-[1126px] mx-w-[1440px] mx-auto px-8 lg:px-[10]">
        <h2 className="lg:text-[64px] md:text-[40px] text-[32px] lg:font-[700] font-[500]">
        ...
        <Button size="lg" variant="secondary" className="w-[244px] h-[58px] text-[24px] font-[500] text-[#282828]">
          Get Started
        </Button>
      </div>
    </div>
