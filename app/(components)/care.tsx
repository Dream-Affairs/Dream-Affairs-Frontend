      ...
      <section>
        <div className="lg:relative lg:mb-[-90px] flex flex-col-reverse lg:flex-row">
          ...
          <div data-aos="zoom-in" data-aos-duration="700" className="pb-6 lg:pl-20 ">
            <h1 className="text-[#48195A] text-[14px] sm:text-[32px] text-center lg:text-left lg:mt-[40%] lg:m-0 m-auto">
              Manage your events
            </h1>
            <p className="text-[12px] sm:text-[18px] text-center lg:text-left pt-4 text-[#65676A]">
        ...
        <div className="relative flex flex-col lg:flex-row">
          <div data-aos="zoom-in" data-aos-duration="700" className="py-8 lg:pb-6 lg:pr-20 ">
            <h1 className="text-[#48195A] text-[14px] sm:text-[32px] text-center lg:text-left lg:mt-[45%] lg:m-0 m-auto">
        ...
        <div className="lg:relative lg:mt-[-90px] flex flex-col-reverse lg:flex-row">
          ...
          <div data-aos="zoom-in" data-aos-duration="700" className="py-8 lg:pb-6 lg:pl-20 ">
            <h1 className="text-[#48195A] text-[14px] sm:text-[32px] text-center lg:text-left lg:mt-[50%] lg:m-0 m-auto">
              Manage your meals
            </h1>
            <p className="text-[12px] sm:text-[18px] text-center lg:text-left pt-4 text-[#65676A]">
