...
const Manage = () => {
  return (
    <div>
      {/* header starts here  */}
      <div className="flex bg-primary h-[216px] w-auto pl-12 pt-11 gap-7 mb-12">
        ...
        <div className="text-background flex flex-col gap-6">
          ...
          <div className="flex gap-3">
            <p className="font-light text-sm w-[437px]">
