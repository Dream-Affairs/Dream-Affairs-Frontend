  ...
  return (
    <div>
      {notifications.map((item) => (
        <div
          key={item.id}
          className="flex items-center justify-between shadow-sm border border-slate-300 rounded-lg bg-white mb-[2em]"
        >
          ...
          <div className="px-2 flex items-center justify-between">
            <Link href={item.link} className="px-3 text-[#9B57B6] cursor-pointer">
              view
            </Link>
