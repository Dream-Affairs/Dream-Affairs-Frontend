...
const Preview: React.FC<previewProps> = ({ mealDescription, mealName, files }) => {
  return (
    <div className="w-[45%] flex flex-col pt-[2px] pl-[53px] items-start justify-start ">
      ...
      <div className="border rounded-[8px] lg:mt-[26px] lg:w-[388px] lg:h-[392px] lg:p-[16px]">
        <div>
          {!files ? (
        ...
        <div className="flex flex-col gap-y-[12px] lg:mt-[16px]">
          <h3 className="font-[600] lg:text-[24px] lg:leading-[33.6px] text-[#282828] ">
            {mealName || <h3>Meal Name</h3>}
          </h3>
          <h4 className="text-[#6F6F6F] lg:text-[16px] font-[400] lg:leading-[22.4px]">{mealDescription || <h3>Meal Description</h3>}</h4>
