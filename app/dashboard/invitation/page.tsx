  ...
  return (
    <div>
      ...
      <div className="w-full h-[280px] bg-red-500">
        <Image src={banner} alt="top-banner" width={0} height={0} style={{ width: '100vw', height: '100%' }} />
      </div>
      ...
      <div className="w-full flex pt-[60px] gap-x-[40px] gap-y-8 px-[4%] mb-[90px] flex-wrap">
        <div className="shrink-0 basis-[23%]">
          <EmailTemplate
            ...
            description="This the email you send to guests, for them to
            get access code, view website and RSVP"
            image="/assets/email_template.png"
          />
        </div>
        <div className="shrink-0 basis-[23%]">
          <EmailTemplate
